...
#| tbl-cap: "Summary statistics of `revenue` in each `sales_pitch` in telemarketing data"
...
#| fig-cap: "Distribution of `revenue` in each `sales_pitch` in telemarketing data"
#| fig-asp: 0.5625
...
#| tbl-cap: "ANOVA table for testing the `revenue` difference across `sales_pitch`"
